...
function Header()
{
    ...
    // $this->Image('../../imagen/saikel.jpg',10,10,15); //imagen(archivo, png/jpg || x,y,tamaño)
    $this->setXY(60,15);
    $this->Cell(80,8,'Informe de Inventario',0,1,'C',0);
...
$pdf->Cell(20,8,'Stock Max','B',0,'C',0);
$pdf->Cell(35,8,'Stock Min','B',0,'C',0);
$pdf->Cell(25,8,'Costo','B',0,'C',0);
$pdf->Cell(20,8,'Cantidad','B',0,'C',0);
$pdf->Cell(30,8,'Total','B',1,'C',0);
...
$pdf->Cell(20,8,'...','B',0,'C',1);
$pdf->Cell(35,8,'...','B',0,'C',1);
