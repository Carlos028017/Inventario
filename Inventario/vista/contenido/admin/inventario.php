...
<body>
    ...
    <div class="container">
        <a href="../../../vista/formularios/admin/formulario_inventario.php" class="btn btn-primary mb-3">Nuevo Inventartio</a>
        <table class="table">
            <thead>
                <tr>
                    <th>Producto</th>
            ...
            <tbody>
                <?php foreach ($Inventario as $Inventario): ?>
                    <tr>
                        <td>
                            <?php echo $Inventario["id_producto"]; ?>
                        </td>
                        <td>
                        ...
                        <td>
                            <?php echo $Inventario["stockmin"]; ?>
                        </td>
                        <td>
                            <?php echo $Inventario["stockmax"]; ?>
                        </td>
                        <td>
                            <?php echo $Inventario["estado"]; ?>
                        </td>
                        <td>
                        <a href="../procesoscrud/editar.php?id=<?php echo $Inventario["id_marca"]; ?>"><i class="bi bi-pen"
                                title="Editar"></i></a>
                        <a href="../procesoscrud/eliminar.php?id=<?php echo $Inventario["id_marca"]; ?>"><i class="bi bi-trash3"
                                title="Eliminar"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
