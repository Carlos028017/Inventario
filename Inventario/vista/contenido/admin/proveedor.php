...
<body>
    ...
    <div class="container">
        <a href="../../../vista/formularios/admin/formulario_proveedor.php" class="btn btn-primary mb-3">Nueva Marca</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($proveedor as $prov): ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $prov["celular"]; ?>
                        </td>
                        <td>
                            <?php echo $prov["correo"]; ?>
                        </td>
                        <td>
                            <?php echo $prov["id_representante"]; ?>
                        </td>
                        <td>
                            <?php echo $prov["id_pais"]; ?>
                        </td>
                        <td>
                            <?php echo $prov["id_departamento"]; ?>
                        </td>
                        <td>
                            <?php echo $prov["id_ciudad"]; ?>
                        </td>
                        <td>
                            <?php echo $prov["direccion"]; ?>
                        </td>
                        <td>
                            <?php echo $prov["estado"]; ?>
                        </td>
                        <td>
                        <a href="../procesoscrud/editar.php?id=<?php echo $prov["id_proveedor"]; ?>"><i class="bi bi-pen"
                                title="Editar"></i></a>
                        <a href="../procesoscrud/eliminar.php?id=<?php echo $prov["id_proveedor"]; ?>"><i class="bi bi-trash3"
                                title="Eliminar"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
