...
<body>
    ...
    <div class="container">
        <a href="../../../vista/formularios/admin/formulario_departamento.php" class="btn btn-primary mb-3">Nueva Marca</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($departamentos as $departamento): ?>
                    <tr>
                        ...
                        <td>
                        <a href="../procesoscrud/editar.php?id=<?php echo $departamento["id_departamento"]; ?>"><i class="bi bi-pen"
                                title="Editar"></i></a>
                        <a href="../procesoscrud/eliminar.php?id=<?php echo $departamento["id_departamento"]; ?>"><i class="bi bi-trash3"
                                title="Eliminar"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
