...
<body>
    ...
    <div class="container">
        <a href="../../../vista/formularios/admin/formulario_pais.php" class="btn btn-primary mb-3">Nuevo pais</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($pais as $pais): ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $pais["estado"]; ?>
                        </td>
                        <td>
                        <a href="../procesoscrud/editar.php?id=<?php echo $marca["id_pais"]; ?>"><i class="bi bi-pen"
                                title="Editar"></i></a>
                        <a href="../procesoscrud/eliminar.php?id=<?php echo $marca["id_pais"]; ?>"><i class="bi bi-trash3"
                                title="Eliminar"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
