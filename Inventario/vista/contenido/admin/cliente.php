...
<body>
    ...
    <div class="container">
        <a href="../../../vista/formularios/admin/formulario_cliente.php" class="btn btn-primary mb-3">Nuevo cliente</a>
        <table class="table">
            <thead>
                <tr>
                    <th>Cedula</th>
            ...
            <tbody>
                <?php foreach ($clintes as $cliente): ?>
                    <tr>
                        <td>
                        ...
                        <td>
                            <?php echo $cliente["id_pais"]; ?>
                        </td>
                        <td>
                            <?php echo $cliente["id_departamento"]; ?>
                        </td>
                        <td>
                            <?php echo $cliente["id_ciudad"]; ?>
                        </td>
                        <td>
                        ...
                        <td>
                        <a href="../procesoscrud/editar.php?id=<?php echo $clinte["id_cliente"]; ?>"><i class="bi bi-pen"
                                title="Editar"></i></a>
                        <a href="../procesoscrud/eliminar.php?id=<?php echo $clinte["id_cliente"]; ?>"><i class="bi bi-trash3"
                                title="Eliminar"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
