...
<body>
    ...
    <div class="container">
        <a href="../procesoscrud/crear.php" class="btn btn-primary mb-3">Nuevo Rol</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($roles as $rol): ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $rol["descripcion_rol"]; ?>
                        </td>
                        <td>
                            <?php echo $rol["estado"]; ?>
                        </td>
                        <td>
                        <a href="../procesoscrud/editar.php?id= <?php echo $rol["id_rol"]; ?>"><i class="bi bi-pen"
                                title="Editar"></i></a>
                        <a href="../procesoscrud/eliminar.php?id= <?php echo $rol["id_rol"]; ?>"><i class="bi bi-trash3"
                                title="Eliminar"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
