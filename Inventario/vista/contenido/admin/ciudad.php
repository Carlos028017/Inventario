...
<body>
    ...
    <div class="container">
        <a href="../../../vista/formularios/admin/formulario_ciudad.php" class="btn btn-primary mb-3">Nueva Ciudad</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($ciudad as $ciudad): ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $ciudad["id_departamento"]; ?>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            if($ciudad["estado"] == 1){
                                echo "Activo";
                            }else if($ciudad["estado"] == 0){
                                echo "inactivo";
                            }
                            ?>
                        </td>
                        <td>
                        <a href="crud/eliminar.php?id=<?php echo $marca["id_marca"]; ?>"><i class="bi bi-pen"
                                title="Editar"></i></a>
                        <a href="crud/eliminar.php?id=<?php echo $marca["id_marca"]; ?>"><i class="bi bi-trash3"
                                title="Eliminar"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
