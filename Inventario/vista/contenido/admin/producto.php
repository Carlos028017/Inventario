...
<body>
    ...
    <div class="container">
        <a href="../../../vista/formularios/admin/formulario_producto.php" class="btn btn-primary mb-3">Nuevo Producto</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($producto as $prod): ?>
                    <tr>
                        ...
                        <td>
                        <a href="../procesoscrud/editar.php?id=<?php echo $prod["id_marca"]; ?>"><i class="bi bi-pen"
                                title="Editar"></i></a>
                        <a href="../procesoscrud/eliminar.php?id=<?php echo $prod["id_marca"]; ?>"><i class="bi bi-trash3"
                                title="Eliminar"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
