...
<body>
    <header class="log">
        <font>
            ...
            <font class="cabeza">
                <b>Formulario para crear una marca</b>
            </font>
        </font>
    </header>
    <div class="container">
        <form class="center" action="../../../../modelo/admin/editarMarca.php" method="POST">
        <input type="hidden" name="id_marca" value="<?php echo $marcas["id_marca"]; ?>">
            <div class="fila">
                <div class="txt_field">
                    <label for="nombre">Nombre:</label>
                    <input type="text" id="nombre" name="nombre" value="<?php echo $marcas["nombre"]; ?>" required><br>
                </div><br>

                <div class="txt_field">
                    <label for="estado">Estado</label>
                    <select type="text" for="estado" id="estado" name="estado" aria-label="Default select example">
                        <option id="estado" name="estado" value="1">Activo</option>
                        <option id="estado" name="estado" value="0">inactivo</option>
                    </select>
                </div><br>
            </div>
            ...
            <div class="fila">
                <font class="pass">
                    <input href="" class="boton" type="submit" value="Editar Marca" onclick="">
