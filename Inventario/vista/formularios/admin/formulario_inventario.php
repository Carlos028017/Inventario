...
<body>
    <header class="log">
        <font>
            ...
            <font class="cabeza">
                <b>Formulario para crear un Inventario</b>
            </font>
        </font>
    </header>
    <div class="container">
        <form class="center" action="" method="POST">
            ...
            <div class="fila">
                <div class="txt_field">
                    ...
                    <input type="text" id="codigoproducto" name="codigoproducto" value="" required><br>
                </div>
            ...
            <div class="fila">
                ...
                <div class="txt_field">
                    ...
                    <input type="text" id="stockmin" name="stockmin" value="" required><br>
                </div>
            </div>
            ...
            <div class="fila">
                <div class="txt_field">
                    ...
                    <input type="text" id="stockmax" name="stockmax" value="" required><br>
                </div> <br>
            ...
            <div class="fila">
                <font class="pass">
                    <input href="" class="boton" type="submit" value="crear inventario" onclick="">
