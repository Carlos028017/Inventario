...
<body>
    <header class="log">
        <font>
            ...
            <font class="cabeza">
                <b>Formulario para crear una compra</b>
            </font>
        </font>
    </header>
    <div class="container">
        <form class="center" action="" method="POST">
            ...
            <div class="fila">
                <div class="txt_field">
                    <label for="numero_doc">Nomero documento proveedor:</label>
                    <input type="text" id="numero_doc" name="numero_doc" value="" required><br>
                </div>

                <div class="txt_field">
                    <label for="fecha">Fecha:</label>
                    <input type="text" id="fecha" name="fecha" value="" required><br>
                </div>
            </div>
            ...
            <div class="fila">
                <div class="txt_field">
                    ...
                    <input type="text" id="descuento" name="descuento" value="" required><br>
                </div>

                <div class="txt_field">
                    <label for="totalcompra">Total compra:</label>
                    <input type="text" id="totalcompra" name="totalcompra" value="" required><br>
                </div>
            </div>
            <div class="fila">
                <div class="txt_field">
            ...
            <div class="fila">
                <font class="pass">
                    <input href="" class="boton" type="submit" value="crear compra" onclick="">
