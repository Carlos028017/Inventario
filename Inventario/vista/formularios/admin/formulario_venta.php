...
<body>
    <header class="log">
        <font>
            ...
            <font class="cabeza">
                <b>Formulario para crear una venta</b>
            </font>
        </font>
    </header>
    <div class="container">
        <form class="center" action="" method="POST">
            ...
            <div class="fila">
                <div class="txt_field">
                    <label for="numero_doc">Cedula del cliente:</label>
            ...
            <div class="fila">
                ...
                <div class="txt_field">
                    ...
                    <input type="text" id="Totalventa" name="Totalventa" value="" required><br>
                </div>
            </div>
            ...
            <div class="fila">
                <font class="pass">
                    <input href="" class="boton" type="submit" value="crear venta" onclick="">
