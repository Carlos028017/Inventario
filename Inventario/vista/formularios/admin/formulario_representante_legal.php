...
<body>
    <header class="log">
        <font>
            ...
            <font class="cabeza">
                <b>Formulario para crear un Representante legal</b>
            </font>
        </font>
    </header>
    <div class="container">
        <form class="center" action="" method="POST">
            ...
            <div class="fila">
                <div class="txt_field">
                    <label for="numero_doc">Nomero de documento:</label>
            ...
            <div class="fila">
                ...
                <div class="txt_field">
                    ...
                    <select type="text" for="departamento" name="form-select" aria-label="Default select example">
            ...
            <div class="fila">
                ...
                <div class="txt_field">
                    ...
                    <select type="text" for="ciudad" name="form-select" aria-label="Default select example">
            ...
            <div class="fila">
                <div class="txt_field">
                    <label for="numero_doc">Direccccion:</label>
                    <input type="text" id="numero_doc" name="numero_doc" value="" required><br>
                </div><br>
            ...
            <div class="fila">
                <font class="pass">
                    <input href="" class="boton" type="submit" value="crear representante" onclick="">
